...
export default function HeroSection({ scrollYProgress }: any) {
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto w-full z-10 relative flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen px-6 py-12 lg:py-0 gap-8 lg:gap-0">
          
          {/* Left Content */}
          <div className="flex-1 text-left w-full">
            <FadeIn delay={0.2} direction="right">
              <h1 className="font-display flex flex-col mb-6 md:mb-8">
                <span className="text-xl md:text-4xl text-arven-yellow font-bold tracking-[0.2em] uppercase mb-2">Proposta</span>
                <span className="text-5xl md:text-9xl font-black text-white tracking-tighter leading-none">COMERCIAL</span>
              </h1>
              
              <p className="text-lg md:text-3xl text-slate-300 font-light mb-8 md:mb-12 max-w-xl leading-relaxed">
                Soluções estratégicas que <br className="hidden md:block"/> <span className="text-white font-medium">impulsionam resultados.</span>
              </p>

              <div className="h-1 w-16 md:h-1.5 md:w-24 bg-arven-yellow mb-10 md:mb-16 rounded-full" />
              ...
              <div className="grid grid-cols-3 gap-4 md:gap-8">
                ...
                <div className="flex flex-col items-center md:items-start gap-3 md:gap-4 border-l border-white/10 px-2 md:px-0 md:pl-8">
          ...
          <div className="flex-1 flex justify-center lg:justify-end relative w-full mb-8 lg:mb-0">
            <FadeIn delay={0.5} direction="left" className="relative">
              ...
              <ArvenLogo className="relative z-10 scale-90 md:scale-150 lg:scale-[1.8]" priority={true} />
            </FadeIn>
          </div>
